...
//
//
import SingerCard5 from '@/public/figure/singer/ab6761670000ecd467d4b4774067ac42601abbe4.jpg'
//
//
//
//CSS設定，放在同一層
    ...
    <>
      ...
      >
        <div className={`${styles.imgwrap}`}>
          ...
          {/*  */}
          {/*  */}
          <Link href={`http://localhost:3000/figure/singer/92`}>
            {/*  */}
            {/*  */}
            {/*  */}
            <Image
        ...
        <div className="card-body text-white mt-3">
          ...
          {/*  */}
          {/*  */}
          <h5 className="card-title ">林俊傑</h5>
          {/*  */}
          {/*  */}
          {/*  */}
