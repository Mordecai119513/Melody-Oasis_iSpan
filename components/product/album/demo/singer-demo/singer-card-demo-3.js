...
//
//
import SingerCard3 from '@/public/figure/singer/ab6761670000ecd470bc10859c4d9763ec729841.jpg'
//
//
//
//CSS設定，放在同一層
    ...
    <>
      ...
      >
        <div className={`${styles.imgwrap}`}>
          ...
          {/*  */}
          {/*  */}
          <Link href={`http://localhost:3000/figure/singer/74`}>
            {/*  */}
            {/*  */}
            {/*  */}
            <Image
        ...
        <div className="card-body text-white mt-3">
          ...
          {/*  */}
          {/*  */}
          <h5 className="card-title ">周杰倫</h5>
          {/*  */}
          {/*  */}
          {/*  */}
