...
import DemoCard4 from '@/public/product/album/R-3286385-1324016613.jpg'
    ...
    <>
      ...
      >
        <div className={`${styles.imgWrap} rounded p-2`}>
          <Link href={`http://localhost:3000/product/album/142`}>
            <Image
        ...
        >
          <div className="d-flex justify-content-between ">
            <div className="pe-1">
              <h5 className="card-title text-break">時光機</h5>
              <p className="card-text text-break">五月天</p>
            </div>
            <div className="">
              <Image
                className="img "
          ...
          <div className="d-flex justify-content-end position-absolute bottom-0 start-0">
            <p className="card-text text-white-50 text-break">2003-11-11</p>
          </div>
