...
import DemoCard5 from '@/public/product/album/R-1604163-1231603226.jpg'
    ...
    <>
      ...
      >
        <div className={`${styles.imgWrap} rounded p-2`}>
          <Link href={`http://localhost:3000/product/album/56`}>
            <Image
        ...
        >
          <div className="d-flex justify-content-between ">
            <div className="pe-1">
              <h5 className="card-title text-break">In Pieces</h5>
              <p className="card-text text-break">Garth Brooks</p>
            </div>
            <div className="">
              <Image
                className="img "
          ...
          <p className="card-text text-break mb-2">$429</p>
          <div className="d-flex justify-content-end position-absolute bottom-0 start-0">
            <p className="card-text text-white-50 text-break">1993-08-31</p>
          </div>
