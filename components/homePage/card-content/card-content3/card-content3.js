...
//商品列表頁，放在public
import TheThirdAlbumCover from '@/public/product/album/R-367129-1150256146.jpg'
//CSS設定，放在同一層
import styles from './style.module.scss'
//收藏商品的toggle效果的js，放在子層
import HeartToggle from '../heart/heart-toggle'

export default function HomeAlbumProductCard3() {
  return (
    <>
      <div className="p-3 bg-light mt-2 rounded">
        ...
        <div className="card-body text-white mt-2">
          ...
          <h3 className="card-title">Dookie</h3>
          <p className="card-text"> </p>
        </div>
      </div>
    </>
