...
const CartTicketContext = createContext(null)
...
export const CartTicketProvider = ({
  children,
...
export const useTicketCart = () => useContext(CartTicketContext)
